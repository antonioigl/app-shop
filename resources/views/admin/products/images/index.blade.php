                            ...
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    ...
                                    <form method="post" action="">
                                        ...
                                        @else
                                            <a href="{{url('/admin/products/'.$product->id.'/images/select/'.$image->id)}}" class="btn btn-primary btn-fab btn-fab-mini btn-round" data-toggle="tooltip" title="Destacar esta imagen">
                                                <i class="material-icons">favorite</i>
                                            </a>
                                        @endif
                                    </form>
