        ...
        <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="info">
                                ...
                                <p>Todo pedido que realices será confirmado a través de una llamada. Si no confías en los pagos en línea puedes pagas contra entrega el valor acordado.</p>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="info">
            ...
            <div class="section text-center">
                ...
                <form class="form-inline" method="get" action="{{url('/search')}}">
                    <input type="text" id="search" placeholder="¿Qué producto buscas?" class="form-control" name="query">
